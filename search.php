...
{               ?>
                  ...
                  <div class="box">
                    ...
                    <div class="text-col">
                      ...
                      <a href="jobs-details.php?jobid=<?php echo ($row->jobId);?>" class="text">Location: <?php  echo htmlentities($row->jobLocation);?></a></br> <a href="#" class="text">Calender: <?php  echo htmlentities($row->postinedate);?> </a> </div>
