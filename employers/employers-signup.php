...
$ret="SELECT * FROM  tblemployers where (Ph=:uemail || Email=:Ph)";
$queryt = $dbh -> prepare($ret);
$queryt->bindParam(':uemail',$emaill,PDO::PARAM_STR);
$queryt->bindParam(':Ph',$Ph,PDO::PARAM_STR);
...
// Query for Insertion
$isactive=1;
$sql="INSERT INTO tblemployers(Name,Ph,Email,EmpPassword,Image,Is_Active) VALUES(:conrnper,:emaill,:Ph,:hashedpass,:logoname,:isactive)";
...
{
$error="Ph or Email Already Exist";
}
}
}
?>
...
<input type="text" name="email" id="email" placeholder="Phone Number Here..." autocomplete="off" maxlength="12" required>
 <span id="user-availability-status1" style="font-size:12px;"></span>
</div>

<div class="col-md-6 col-sm-6">
<label>Email</label>
<input type="email" name="Ph" id="Ph" onBlur="userAvailability()"  placeholder="Email Here..." autocomplete="off"  required>
 <span id="user-availability-status1" style="font-size:12px;"></span>
</div>
